...
(describe
 ...
 (it "scales a vector to the desired magnitude"
     (should= 2 (.ceil js/Math (util/distance (util/scale-to (util/->world 1 1) 2)))))
 (it "preserves the direction of the provided vector"
     (should= (util/->world -1 0) (util/scale-to (util/->world -1 0) 1)))
 (it "doesn't die on 0 length"
     (should= (util/->world 0 0) (util/scale-to (util/->world 10 10) 0))))
